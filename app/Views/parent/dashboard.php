...
<section class="row g-3 mb-4" aria-label="Ringkasan hari ini">
    <div class="col-12 col-sm-6"><div class="card border-0 shadow-sm h-100"><div class="card-body"><p class="small text-secondary mb-1">Ganjaran Menunggu Kelulusan</p><p class="h2 mb-0"><?= esc($pendingRewards) ?></p></div></div></div>
    <div class="col-12 col-sm-6"><div class="card border-0 shadow-sm h-100"><div class="card-body"><p class="small text-secondary mb-1">Pendahulu Hari Ini</p><p class="h5 mb-0"><?= isset($todayRanking['rows'][0]) ? esc($todayRanking['rows'][0]['name']) : '—' ?></p></div></div></div>
</section>
