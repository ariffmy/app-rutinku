...
class DemoSeeder extends FamilyInitializationSeeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['name' => 'Child One', 'email' => 'child1@example.com', 'username' => 'child-one-internal', 'password' => 'password', 'role' => UserRole::CHILD],
            ['name' => 'Child Two', 'email' => 'child2@example.com', 'username' => 'child-two-internal', 'password' => 'password', 'role' => UserRole::CHILD],
            ['name' => 'Child Three', 'email' => 'child3@example.com', 'username' => 'child-three-internal', 'password' => 'password', 'role' => UserRole::CHILD],
        ];
